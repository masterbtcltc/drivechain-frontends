...
class EnforcerConfigOptions {
  static const List<EnforcerConfigOption> allOptions = [
    ...
    EnforcerConfigOption(
      ...
      tooltip: 'Litecoin Core RPC address. Automatically inherited from your Litecoin Core configuration.',
      inputType: EnforcerConfigInputType.text,
      isReadOnly: true,
      defaultValue: '127.0.0.1:19443',
    ),
    EnforcerConfigOption(
      key: 'node-rpc-cookie-path',
      category: 'Node RPC',
      description: 'Cookie Path',
      tooltip: 'Path to Litecoin Core cookie file. Cannot be set together with user + password.',
      inputType: EnforcerConfigInputType.path,
    ),
    EnforcerConfigOption(
      key: 'node-rpc-user',
      ...
      tooltip: 'RPC username for Litecoin Core. Automatically inherited from your Litecoin Core configuration.',
      inputType: EnforcerConfigInputType.text,
      isReadOnly: true,
    ),
    EnforcerConfigOption(
      ...
      tooltip: 'RPC password for Litecoin Core. Automatically inherited from your Litecoin Core configuration.',
      inputType: EnforcerConfigInputType.text,
      isReadOnly: true,
    ),
    EnforcerConfigOption(
      ...
      tooltip: 'Path to the Litecoin Core blocks directory.',
      inputType: EnforcerConfigInputType.path,
    ),
    EnforcerConfigOption(
      ...
      tooltip:
          'Litecoin node ZMQ endpoint for `sequence`. If not set, the enforcer tries to find it via bitcoin-cli getzmqnotifications.',
      inputType: EnforcerConfigInputType.text,
    ),
    ...
    EnforcerConfigOption(
      ...
      tooltip: 'Path to the Python mining script from Litecoin Core. If not set, downloaded from GitHub.',
      inputType: EnforcerConfigInputType.path,
    ),
    EnforcerConfigOption(
